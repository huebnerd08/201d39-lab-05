...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  var sumElement = sum(a, b)[0];
console.log(sumElement);
// var productElement = multiply(a, b)[0], c)[0];
// var sumElementArray = a + ' and ' + b + ' and ' c + ' sum to ' sumElement + '.';
// var poductElementArray = 'The product of ' + a + ' and ' + ' and ' + c ' is ' productElement + '.';

// return [sumElement,productElement,sumElementArray,productElementArray];
