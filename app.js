...
function testSumArray(sumArr) { //eslint-disable-line
  var sumTestArr = sum(sumArr[0], sumArr[1][0], sumArr[2][0]);
  var sumArrOutput = sumArr[0] + ',' + sumArr[1] + ',' + sumArr[2] + ' was passed in as an array of numbers, and ' + sumTestArr + ' is their sum.';

  // console.log(sumArrOutput);

  return[sumTestArr,sumArrOutput];
...
function testMultiplyArray(multArr) { //eslint-disable-line
  var multTestArr = multiply(multArr[0], multArr[1][0], multArr[2][0]);
  var multArrOutput = 'The numbers ' + multArr[0] + ',' + multArr[1] + ',' + multArr[2] + ' have a product of ' + multTestArr + '.';

  console.log(multTestArr, multArrOutput);

  return [multArrOutput];
}
